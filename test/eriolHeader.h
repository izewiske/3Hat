...
struct Poly3 {  // represents a collection of polygons in 3d
  ...
  Coord3 trans, rot;
  double scale;
  int selectedVert[4];  // allow selection of four vertices, for alignment
  ...
  void init() { selected=false; scale=1; selectedVert[0] = selectedVert[1] = 
                                    selectedVert[2] = selectedVert[3] = -1; }
  Poly3() { init(); }
  Poly3( const char * );
